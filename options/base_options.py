...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--print_network', action='store_true', default=False, help='print_network')
        ...
        self.parser.add_argument('--seg_checkpoint', type=str, default='seg_final.pth')
        self.parser.add_argument('--gmm_checkpoint', type=str, default='gmm_final.pth')
        self.parser.add_argument('--alias_checkpoint', type=str, default='alias_final.pth')
        ...
        # for GMM
        self.parser.add_argument('--use_gmm', action='store_true')
        self.parser.add_argument('--grid_size', type=int, default=5)

        # for ALIASGenerator
        self.parser.add_argument('--use_alias', action='store_true')
        self.parser.add_argument('--inpaint', action='store_true')
